...
import '../widgets/update_player.dart';
import '../widgets/delete_player.dart';
...
class _EditPlayerScreenState extends State<EditPlayerScreen> {
  ...
  late RangeValues _skillLevelRange;
  ...
  void initState() {
    ...
    _contactNumberController.text = widget.player.contactNumber;
    _emailController.text = widget.player.email;
    _addressController.text = widget.player.address;
    _remarksController.text = widget.player.remarks;
    
    _skillLevelRange = RangeValues(
      widget.player.skillLevelMin,
      widget.player.skillLevelMax,
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Edit ${widget.player.nickname}'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              DeletePlayerButton(player: widget.player),
